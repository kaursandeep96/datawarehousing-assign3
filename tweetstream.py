...
if __name__ == '__main__':
        ...
        # Local connection
        host = "10.162.0.2"          # Get local machine name (copy internal address from EC2 instance).
